...
// to do: in future add taxonies for categories like: food provided, food available for purchase, fundraiser, onsite at Prescott Elementary, free to attend, donation to attend, etc
...
function resources() {
	...
	$args = array(
		...
		'description'           => __( 'Resources for board reference', 'text_domain' ),
		'labels'                => $labels,
...
// to do:
// ---resources---, ---events---, team, image gallery, fundraising campaigns, newsletters
